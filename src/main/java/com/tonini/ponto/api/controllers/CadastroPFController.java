...
import com.tonini.ponto.api.dtos.CadastroPFDto;
...
public class CadastroPFController {
	...
	private CadastroPFDto converterCadastroPFDto(Funcionario funcionario) {
		...
		funcionario.getQtdHorasTrabalhoDiaOpt().ifPresent(qtdOrasTrabalhoDia -> cadastroPFDto
				.setQtdHorasTrabalhoDia(Optional.of(Float.toString(qtdOrasTrabalhoDia))));
